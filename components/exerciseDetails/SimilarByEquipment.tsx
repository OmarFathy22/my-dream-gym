...
const SecondSection = ({equipment}:any) => {
  const [value, loading, error] = useDocument(doc(db, "List by equipment", equipment));
  ...
  return (
    <Main>
       <h1  className="text-[30px] pl-[40px] text-left w-full  font-bold">Similar <span className="text-red-500">Equipment</span> Exerscises</h1>
    <ExercisesContainer >
